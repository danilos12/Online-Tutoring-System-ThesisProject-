                        ...
                        <div class="bg-white p-3 shadow-lg rounded-sm border">
                            ...
                            <div class="text-gray-700">
                                <div class="grid md:grid-cols-2 text-sm">
                                    ...
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold flex items-center">Current Address</div>
                                        <div class="px-4 py-2"><input id="cur" class="text-black rounded-md border border-slate-400 h-7" type="text"></div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold flex items-center">Permanant Address</div>
                                        <div class="px-4 py-2"><input id="per" class="text-black rounded-md border border-slate-400 h-7" type="text"></div>
                                    </div>

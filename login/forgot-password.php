    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {        
            ...
            try {
                ...
                $mail->Body    = 'Click the link to change password <b><a href="owlhub.me/login/change-password?reset='.$code.'">owlhub.me/login/change-password?reset='.$code.'</a></b>';
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <div class="social-icons">
                            <p>Back to! <a href="index">Login</a>.</p>
                        </div>
                    </div>
                </div>
            </div>

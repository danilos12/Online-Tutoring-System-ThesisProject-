...
<div class="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1080px">
        <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 bg-black py-10 px-10">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-900">Apply As Tutor</h1>
                    <p>Enter your information to apply</p>
                </div>
                <form action="" id="add">
                <div class="">
                    <div class="flex space-y-0 -mx-3 mb-0">
                        <div class="w-1/2 px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1 text-black">First name</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                <input type="text" id="fname" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"  required>
                            </div>
                        </div>
                        <div class="w-1/2 px-3 mb-1">
                            <label for="" class="text-xs font-semibold px-1 text-black">Last name</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                <input id="lname" type="text"  class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"  required>
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-1">
                            ...
                            <div class="flex">
                                ...
                                <input id="emails" type="email"  class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" required>
                            </div>
                        </div>
                    </div>
                 
                    
                  <div class="block hey pt-6" >
                    <div class="flex -mx-3 -my-4 ">
                        <div class="w-full px-3 mb-10 block align-middle">

                            <div class="flex space-x-3">
                                <div class="block">
                                    <label class="block  text-sm font-semibold text-gray-900" for="file_input">Upload Introductory Video</label>
                                <input class="block w-full text-sm text-gray-900 rounded-lg cursor-pointer focus:outline-none" id="file_input1" type="file" required>
                            </div>
                            <div class="block">
                                <label class="block  text-sm font-semibold text-gray-900" for="file_input">Upload ID</label>
                                <input class="block w-full text-sm text-gray-900 rounded-lg  cursor-pointer focus:outline-none" id="file_input2" type="file" required>
                            </div>
                            </div>
                    ...
                    <div class="flex -mx-3 -my-4 ">
                        <div class="w-full px-3 mb-10 block align-middle">
                            ...
                            <div class="flex space-x-3">
                                <div class="block">
                                        <label class="block  text-sm font-semibold text-gray-900" for="file_input">Upload Diploma</label>
                                    <input class="block w-full text-sm text-gray-900 rounded-lg cursor-pointer focus:outline-none" id="file_input3" type="file" required>
                                </div>
                                <div class="block">
                                    <label class="block  text-sm font-semibold text-gray-900" for="file_input">Upload Resume</label>
                                    <input class="block w-full text-sm text-gray-900 rounded-lg  cursor-pointer focus:outline-none" id="file_input4" type="file" required>
                                </div>
                ...
                <input type="hidden" value="1" id="total_chq">
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button id="submit" type="submit" class="block w-full max-w-xs mx-auto bg-black hover:bg-blue-600 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">SUBMIT APPLICATION</button>
                        </div>
                    </div>
                </div>
            </form>
                    <div class="w-full  block">
                        ...
                        <div class="">
                            <a href="../login/register" class="hover:text-blue-600 hover:border-b-2">Register as Student</a>
                        </div>
                        <div class="">
                            <a href="../login/index" class="hover:text-blue-600 hover:border-b-2">Already Have an Account?</a>
                        </div>
...
<script>
                ...
                formData.append("emailsss", email1);

           

                var imagefile1 = document.getElementById('file_input1');
                formData.append("file1", imagefile1.files[0]);

                var imagefile2 = document.getElementById('file_input2');
                formData.append("file2", imagefile2.files[0]);

                var imagefile3 = document.getElementById('file_input3');
                formData.append("file3", imagefile3.files[0]);

                var imagefile4 = document.getElementById('file_input4');
                formData.append("file4", imagefile4.files[0]);
                ...
                axios.post(url, formData, {
                    ...
                    form.reset();
                    toastr.success("You have successfully registered <br><span class='my-font-size'> you will be redirected back to home</span><br>", "Success",{ progressBar: true , closeButton: true , onHidden: function() {window.location.replace("../index");}});
